...
INSERT INTO `shua_config` VALUES ('admin_pwd', 'Q743161828');
INSERT INTO `shua_config` VALUES ('alipay_api', '5');
INSERT INTO `shua_config` VALUES ('tenpay_api', '5');
INSERT INTO `shua_config` VALUES ('qqpay_api', '5');
INSERT INTO `shua_config` VALUES ('wxpay_api', '5');
INSERT INTO `shua_config` VALUES ('style', '1');
INSERT INTO `shua_config` VALUES ('sitename', '释梦代刷网');
INSERT INTO `shua_config` VALUES ('keywords', '释梦代刷网,QQ云商城,代刷网,自助下单,网红助手,网红速成');
INSERT INTO `shua_config` VALUES ('description', '释梦代刷网，专业提供国内网红速方案，帮您走出网红的第一步，我们提供最专业的售前指导，提供最优质的售后服务，给您一个放心的平台！');
INSERT INTO `shua_config` VALUES ('kfqq', '743161828');
...
<a target="_blank" class="btn btn-info" href="http://wpa.qq.com/msgrd?v=3&uin=743161828&site=qq&menu=yes"><i class="fa fa-qq"></i> 联系客服</a>
...
<tbody>
<tr height="50">
<td><button type="button" class="btn btn-block btn-warning"><a href="http://" target="_blank"><span style="color:#ffffff">♚♚</span></a></button></td>
<td><button type="button" class="btn btn-block btn-warning"><a href="http://" target="_blank"><span style="color:#ffffff">♚♚</span></a></button></td>
</tr>
<tr height="50">
<td><button type="button" class="btn btn-block btn-success"><a href="http://" target="_blank"><span style="color:#ffffff">♚♚</span></a></button></td>
<td><button type="button" class="btn btn-block btn-success"><a href="http://" target="_blank"><span style="color:#ffffff">♚♚</span></a></button></td>
</tr></tbody>
</table>');
