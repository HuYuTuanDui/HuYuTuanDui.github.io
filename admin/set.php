	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="alipay_api" default="';
																																	...
																																	echo '"><option value="0">关闭</option><option value="5">码支付免签约接口</option></select>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="tenpay_api" default="';
																																	...
																																	echo '"><option value="0">关闭</option><option value="1">财付通官方支付接口</option></select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<input type="text" name="codepay_key" class="form-control" value="';
																																		...
																																		echo '">
			<pre><font color="green">需要下载软件监控订单才可以自动充值等，联系释梦可购买挂机宝<br>QQ:743161828</font></pre>
		</div>
	</div>
	';
																																	}
	  ...
	  <a href="https://codepay.fateqq.com/i/457393"><font color="red" size="5">点我进入码支付注册</font></a>
	 </div>
	</div>
  </form>
</div>
...
';
																																	...
																																	if ($mod == 'epay_n') {
																																		$payapi = pay_api(true);
																																		if ($conf['payapi'] == 0 - 1 && $payapi == false) {
																																		...
																																		if ($mod == 'epay') {
																																			...
																																			echo '<div class="block">
<div class="block-title"><h3 class="panel-title">战狼易支付设置</h3></div>
<div class="">
<ul class="nav nav-tabs"><li class="active"><a href="#">战狼易支付设置</a></li><li><a href="./set.php?mod=epay_order">订单记录</a></li><li><a href="./set.php?mod=epay_settle">结算记录</a></li></ul>
...
';
																																			...
																																			if ($mod == 'epay_settle') {
																																				...
																																				echo '<div class="block"><div class="block-title w h"><h3 class="panel-title">战狼易支付结算记录</h3></div>
        ...
        <table class="table table-striped">
          ...
          <tbody>';
																																				...
																																				if ($mod == 'epay_order') {
																																					...
																																					echo '<div class="block"><div class="block-title"><h3 class="panel-title">战狼易支付订单记录</h3></div>订单只展示前30条[<a href="set.php?mod=epay">返回</a>]
	<div class="table-responsive">
        <table class="table table-striped">
